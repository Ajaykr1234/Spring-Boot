...
public class EmployeeController {
	...
	@GetMapping("/findEmloyeeByDepartmentName/{name}")
	public ResponseEntity<ResponseStructure<List<Employee>>> findEmployeeByDepartmentName(@PathVariable (name="name") String name) {
		return employeeService.findEmployeeByDepartmentName(name);
	}
	
	@GetMapping("/findEmployeeByDepartmentId/{id}")
	public ResponseEntity<ResponseStructure<List<Employee>>> findEmployeeByDepartmentId(@PathVariable (name="id")  int id) {
